...
function loadAlarmDetailPage() {
	...
	if (typeof parent.lang == "undefined") {
		...
		$("#alarmDetailTable").flexigrid({
			url: "StandardReportTpmsAlarmAction_detail.action",
			dataType: 'json',
			colModel : [
...
function loadAlarmDetailLang(){
	searchOpt.loadLang();
	$("#reportTitle").text(parent.lang.tire_pressure_monitoring_detail);
...
function exportReport(exportType) {
	...
	document.reportForm.action = "StandardReportTpmsAlarmAction_detailExcel.action?exportType="+exportType+"&toMap="+toMap+"&begintime="+$('#begintime').val()+"&endtime="+$('#endtime').val();
...
function getArmTypes() {
	...
	armType.push({id:'tirepressure',name:parent.lang.tire_pressure_exceeded});
	armType.push({id:'temperature',name:parent.lang.temperature_exceeded});
	armType.push({id:'battery',name:parent.lang.battery_voltage_is_low});
	return armType;
}