...
function loadSuccess() {
	...
	if(summaryRanks){
		for (var i = 0; i < summaryRanks.length; i++) {
			a3.push(getArrayName(parent.vehiGroupList, summaryRanks[i].lid) + " " + summaryRanks[i].dt.substring(0,7));
...
function generateSummaryRank(){
	...
	title_2=parent.lang.line_analysis_chart
	title_=parent.lang.before + summaryRanks.length + parent.lang.line_violation
...
function loadFenceSummaryLang(){
	searchOpt.loadLang();
	$("#reportTitle").text(parent.lang.report_trip_line_month);
...
function exportReport(exportType) {
	...
	document.reportForm.action = "StandardReportLineAction_summaryExcel.action?exportType="+exportType+"&begintime="+$('#begintime').val()+"&endtime="+$('#endtime').val()+"&type=line&status=monthly";
