...
function loadAlarmDetailLang(){
	searchOpt.loadLang();
	$("#reportTitle").text(parent.lang.report_video_detail);
...
function exportReport(exportType) {
	...
	document.reportForm.action = "StandardReportAlarmAction_detailExcel.action?exportType="+exportType+"&toMap="+toMap+"&begintime="+$('#begintime').val()+"&endtime="+$('#endtime').val()+"&maintype=video";
...
function getArmTypes() {
	var armType = [];
	armType.push({id:'video',name:parent.lang.all});
	armType.push({id:'videosignal',name:parent.lang.alarm_type_video_signal});
	armType.push({id:'videomask',name:parent.lang.alarm_type_video_mask});
	armType.push({id:'videomotion',name:parent.lang.alarm_type_motion});
	return armType;
}