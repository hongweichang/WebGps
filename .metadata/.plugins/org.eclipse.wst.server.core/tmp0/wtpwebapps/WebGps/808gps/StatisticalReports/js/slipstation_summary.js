...
function loadFenceSummaryPage() {
	...
	if (typeof parent.lang == "undefined") {
		...
		$("#fenceSummaryTable").flexigrid({
			url: "StandardReportSlipStationAction_summary.action",
			dataType: 'json',
			colModel : [
...
function loadFenceSummaryLang(){
	searchOpt.loadLang();
	$("#reportTitle").text(parent.lang.report_sliptsation_summary);
}
...
function exportReport(exportType) {
	...
	document.reportForm.action = "StandardReportSlipStationAction_summaryExcel.action?exportType="+exportType+"&begintime="+$('#begintime').val()+"&endtime="+$('#endtime').val();
