...
(function () { 
     ...
     */
    var _IMAGE_PATH = './google/image/TextIconOverlay/m';
    ...
    var TextIconOverlay = 
        ...
        */
        BMapLib.TextIconOverlay = function(map, position, text, options){
    		this._map = map;
    ...
    TextIconOverlay.prototype = baidu.lang.Class.prototype;
    T.lang.inherits(TextIconOverlay, google.maps.OverlayView, "TextIconOverlay");
    ...
    /**
    *继承Overlay的onAdd方法，自定义覆盖物时必须。
    *@param {Map} map BMap.Map的实例化对象。
    *@return {HTMLElement} 返回覆盖物对应的HTML元素。
    */
    TextIconOverlay.prototype.onAdd = function(){
        ...
        this.getPanes().floatPane.appendChild(this._domElement);
        return this._domElement;   
    };
    
    /**
     *继承Overlay的onRemove方法，自定义覆盖物时必须。
     *@return 无返回值。
     */
    TextIconOverlay.prototype.onRemove = function () {
    	if(this._domElement) {
    ...
    */
    TextIconOverlay.prototype._updatePosition = function(){
    	if (this._domElement && this._position) {
            ...
            var pixelPosition= this.getProjection().fromLatLngToDivPixel(this._position); 
    ...
    */
    TextIconOverlay.prototype._buildCssText = function(style) {    
        ...
        if (T.browser["ie"] < 7) {
            ...
            (offset instanceof google.maps.Size) && (backgroundPosition = offset.width + 'px' + ' ' + offset.height + 'px');          
            csstext.push('background-position:' + backgroundPosition + ';');
        }

        if (size instanceof google.maps.Size){
            if (anchor instanceof google.maps.Size) {
    ...
    */
    TextIconOverlay.prototype._bind = function(){
        ...
        function eventExtend(e, be){
            ...
            if (e && be && x && y && elem){
                var offset = T.dom.getPosition(me._domElement);
                be.pixel = {x: x - offset.left, y: y - offset.top};
                be.point = me.getProjection().fromDivPixelToLatLng(be.pixel);
            }
            return be;
