...
//	alert("changeTool" + id + " " +normal);
	...
	if (btn == 5) {
		if (status) {
			document.getElementById("btnFullScreen").src = "./image/fullscreen.gif";
			document.getElementById("btnFullScreen").title = lang.fullScreen;
		} else {
			document.getElementById("btnFullScreen").src = "./image/fullscreen_exit.gif";
			document.getElementById("btnFullScreen").title = lang.fullScreenExit;
		}
	} else if (btn == 6) {
		if (status) {
			document.getElementById("btnExpand").src = "./image/expand.jpg";
			document.getElementById("btnExpand").title = lang.expand;
		} else {
			document.getElementById("btnExpand").src = "./image/expand_exit.jpg";
