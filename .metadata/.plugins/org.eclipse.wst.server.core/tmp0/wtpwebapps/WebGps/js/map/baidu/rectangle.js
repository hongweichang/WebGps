...
(function() {
    ...
    var RectangleZoom =
         ...
         */
        BMapLib.RectangleZoom = function(map, opts, drawEnd){
            if (!map) {
                return;
            }
...
//                var pxStart = new BMap.Pixel(parseInt(me._fDiv.style.left), parseInt(me._fDiv.style.top));
//                var pxEnd = new BMap.Pixel(parseInt(me._fDiv.style.left) + parseInt(me._fDiv.style.width), parseInt(me._fDiv.style.top) + parseInt(me._fDiv.style.height));
                var ptStart = pt1;
                var ptEnd = pt2;
                ...
                if (typeof me._drawEnd != "undefined") {
                		me._drawEnd(ptStart, ptEnd);
                }
