...
mapobject.maps.initMap = function(id, jindu, weidu, zoom){
	...
	var myOptions = {zoom:this.MAX_ZOOM,scaleControl:true,panControl: true,center:myLatlng,mapTypeId:mapobject.maps.MapTypeId.ROADMAP,mapTypeControlOptions:{mapTypeIds:[mapobject.maps.MapTypeId.ROADMAP,mapobject.maps.MapTypeId.SATELLITE,'OSM']}};
