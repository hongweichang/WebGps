  ...
  implements StandardMonitorDao
{
  ...
  private StringBuffer getQueryStringBuffer()
  {
    ...
    sql.append("Status2 as s2,Status3 as s3,Status4 as s4,YouLiang as yl,Speed as sp,HangXiang as hx,GaoDu as gd,");
  ...
  private List<QueryScalar> getDeviceStatusLiteQueryScalar()
  {
    ...
    scalars.add(new QueryScalar("gd", StandardBasicTypes.INTEGER));
