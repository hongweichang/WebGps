...
function loadAlarmDetailPage() {
	...
	if (typeof parent.lang == "undefined") {
		...
		$("#userLogTable").flexigrid({
			url: "StandardReportUserOnlineAction_summary.action",
			dataType: 'json',
			colModel : [
				...
				{display: parent.lang.report_alarm_total, name : 'count', width : 100, sortable : false, align: 'center'},
				{display: parent.lang.report_alarm_total_times, name : 'times', width : 120, sortable : false, align: 'center'}
				],
...
function loadAlarmDetailLang(){
	searchOpt.loadLang();
	$("#reportTitle").text(parent.lang.report_userOnline_summary);
}
...
function exportReport(exportType) {
	...
	document.reportForm.action = "StandardReportUserOnlineAction_summaryExcel.action?exportType="+exportType+"&begintime="+$('#begintime').val()+"&endtime="+$('#endtime').val();
