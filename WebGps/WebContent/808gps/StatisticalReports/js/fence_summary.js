...
function loadAlarmSummaryPage() {
	...
	if (typeof parent.lang == "undefined") {
		...
		var width = 0;
		if(Math.round(6 * parent.screenWidth/7) - 25 >= 2290) {
			width = 'auto';
		}else {
			width = 2290;
			$('#sysuserLogDate').css('width','2330px');
		}
		$("#alarmSummaryTable").flexigrid({
			...
			colModel : [
				...
				{display: parent.lang.alarm_type_beyond_bounds + "/" + parent.lang.report_handled, name : 'countStr0', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.alarm_type_regionalSpeedingAlarm + "/" + parent.lang.report_handled, name : 'countStr1', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.alarm_type_outOfRegional + "/" + parent.lang.report_handled, name : 'countStr2', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.alarm_type_outOfLine + "/" + parent.lang.report_handled, name : 'countStr3', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.alarm_type_InadequateOrTooLongRoadTravelTime + "/" + parent.lang.report_handled, name : 'countStr4', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.alarm_type_routeDeviation + "/" + parent.lang.report_handled, name : 'countStr5', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.alarm_type_areaOverSpeed_platform + "/" + parent.lang.report_handled, name : 'countStr6', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.alarm_type_areaLowSpeed_platform + "/" + parent.lang.report_handled, name : 'countStr7', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.alarm_type_areaInOut_platform + "/" + parent.lang.report_handled, name : 'countStr8', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.alarm_type_lineInOut_platform + "/" + parent.lang.report_handled, name : 'countStr9', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.alarm_type_areaPoint_platform + "/" + parent.lang.report_handled, name : 'countStr10', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.alarm_type_lineOverSpeed_platform + "/" + parent.lang.report_handled, name : 'countStr11', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.alarm_type_lineLowSpeed_platform + "/" + parent.lang.report_handled, name : 'countStr12', width : 120, sortable : false, align: 'center'}
				],
...
function loadAlarmSummaryLang(){
	searchOpt.loadLang();
	$("#reportTitle").text(parent.lang.report_fence_summary);
}
...
function exportReport(exportType) {
	...
	document.reportForm.action = "StandardReportAlarmAction_summaryExcel.action?exportType="+exportType+"&begintime="+$('#begintime').val()+"&endtime="+$('#endtime').val()+"&type=fence&status=0";
