...
function loadAlarmDetailLang(){
	searchOpt.loadLang();
	$("#reportTitle").text(parent.lang.report_malfunction_detail);
...
function exportReport(exportType) {
	...
	document.reportForm.action = "StandardReportAlarmAction_detailExcel.action?exportType="+exportType+"&toMap="+toMap+"&begintime="+$('#begintime').val()+"&endtime="+$('#endtime').val()+"&maintype=malfunction";
...
function getArmTypes() {
	var armType = [];
	armType.push({id:'malfunction',name:parent.lang.all});
	armType.push({id:'signalloss',name:parent.lang.alarm_type_gps_signal_loss});
