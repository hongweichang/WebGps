...
function loadAlarmSummaryPage() {
	...
	if (typeof parent.lang == "undefined") {
		...
		var width = 0;
		if(Math.round(6 * parent.screenWidth/7) - 25 >= 1900) {
			width = 'auto';
		}else {
			width = 1900;
			$('#sysuserLogDate').css('width','1940px');
		}
		$("#alarmSummaryTable").flexigrid({
			...
			colModel : [
				...
				{display: parent.lang.alarm_type_gps_signal_loss + "/" + parent.lang.report_handled, name : 'countStr0', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.report_GNSSModuleFailure + "/" + parent.lang.report_handled, name : 'countStr1', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.report_GNSSAntennaMissedOrCut + "/" + parent.lang.report_handled, name : 'countStr2', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.report_GNSSAntennaShort + "/" + parent.lang.report_handled, name : 'countStr3', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.report_mainSupplyUndervoltage + "/" + parent.lang.report_handled, name : 'countStr4', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.report_mainPowerFailure + "/" + parent.lang.report_handled, name : 'countStr5', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.report_LCDorDisplayFailure + "/" + parent.lang.report_handled, name : 'countStr6', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.report_TTSModuleFailure + "/" + parent.lang.report_handled, name : 'countStr7', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.report_cameraMalfunction + "/" + parent.lang.report_handled, name : 'countStr8', width : 120, sortable : false, align: 'center'},
				{display: parent.lang.report_VSSFailure + "/" + parent.lang.report_handled, name : 'countStr9', width : 120, sortable : false, align: 'center'}
				],
...
function loadAlarmSummaryLang(){
	searchOpt.loadLang();
	$("#reportTitle").text(parent.lang.report_malfunction_summary);
}
...
function exportReport(exportType) {
	...
	document.reportForm.action = "StandardReportAlarmAction_summaryExcel.action?exportType="+exportType+"&begintime="+$('#begintime').val()+"&endtime="+$('#endtime').val()+"&type=malfunction";
