...
//					checkbox: true,
			...
			usepager: true,
			autoload: false,
			title: parent.lang.report_navPassengerTicketSummary,
			useRp: true,
			rp: 15,
...
function loadTicketDetailLang(){
	searchOpt.loadLang();
	$("#reportTitle").text(parent.lang.report_navPassengerTicketSummary);
}
...
function queryTicketDetail() {
	...
	$('#ticketSummaryTable').flexOptions(
